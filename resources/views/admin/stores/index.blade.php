    ...
    <div class="col-lg-12 mb-30">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h6 class="fw-500">All Stores</h6>
                <a href="{{ route('admin.stores.create') }}" class="btn btn-sm btn-primary">
                    <i class="uil uil-plus me-1"></i> Add Store
                </a>
            </div>
            <div class="card-body">
                    ...
                    <table class="table table-hover mb-0">
                        <thead>
                            <tr class="userDatatable-header">
                                ...
                                <th><span class="userDatatable-title">Address</span></th>
                        ...
                        @include('admin.stores.partials.table')
                    </table>
                </div>

                <div id="pagination-wrapper">
                    @include('admin.partials.pagination', ['data' => $stores])
                </div>
            </div>
        </div>
    </div>
